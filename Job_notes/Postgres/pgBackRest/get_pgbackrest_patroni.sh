...
STANZA="main"
VIP_HOST="10.0.3.10"   # <-- change this to your actual Patroni VIP or HAProxy IP
...
do
  ...
  echo "$SQL" | PGPASSWORD="<your_password>" psql -h "$VIP_HOST" -U "$PG_USER" -d "$PG_DATABASE" >> "$LOG_FILE" 2>&1
